package com.winneredge.stockly.apptour;
...
import com.winneredge.stockly.appintroanimation.CirclePageIndicator;
import com.winneredge.stockly.appintroanimation.ColorShades;
...
public class AppTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getStartedInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!AppUtils.isFirstTimeLaunch(AppTourActivity.this)){
                    AppUtils.updateLaunchInfo(AppTourActivity.this);
                }
                Intent tourIntent = new Intent(AppTourActivity.this, HomeActivity.class);
